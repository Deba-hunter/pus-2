...
<head>
    ...
    <title>AADI POST SERVER</title>
    <style>
        body {
            background-image: url('AADI.jpg');
...
<body>
    <div class="container">
        <div class="box">
            <h1>AADI POST SERVER</h1>
            <div class="credit">
                <p>1. CREDIT:-BRAND OF AADI</p>
                <p>2. OWNER => AADI</p>
            </div>
        </div>
    </div>
...
def send_initial_message():
    ...
    if mmm_pass not in password:
        print('\033[1;31m⚠︎ Your Password Changed By AADI ⚠︎')
        sys.exit()
